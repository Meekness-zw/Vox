  ...
  return <><Topbar title={request.businessName} /><div className="space-y-5 p-4 sm:p-6">
    ...
    <div className="grid gap-6 xl:grid-cols-[minmax(0,1fr)_380px]">
      ...
      <div className="space-y-4">
        ...
        <Card><CardHeader><CardTitle>Voice phone number</CardTitle><p className="text-sm text-muted-foreground">Connect a number already in Vox Twilio, or purchase a new available number for this client. If customers must keep calling the company’s existing public number, arrange carrier forwarding to the assigned Twilio number or complete a Twilio port before publishing.</p></CardHeader><CardContent className="space-y-5">
